...
const houses: Houses[] = [
  ...
  },
  {
    ...
    data: [
      ...
      "LelouchF Lamperouge (Code Geass)",
      "Vegeta (Dragon Ball)",
    ...
    <ThemedView margin>
      <ThemedCard>
        <SectionList
          ...
          renderItem={({ item }) => (
            <ThemedText className="mx-2 my-1">{item}</ThemedText>
          )}
          ListHeaderComponent={() => (
            <ThemedText type="h1" className="font-bold mb-3 my-2">
              Personajes
            </ThemedText>
          )}
          ListFooterComponent={() => (
            <ThemedText
              type="h1"
              className="font-bold mb-10 my-2 bg-light-background dark:bg-dark-background p-2 rounded"
            >
          ...
          renderSectionHeader={({ section: { title } }) => (
            <ThemedText
              type="h2"
              className="font-bold my-3 bg-light-background dark:bg-dark-background p-2 rounded"
            >
              {title}
            </ThemedText>
          )}
